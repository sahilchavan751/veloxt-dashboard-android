...
android {
    namespace = "com.custom.srt_stream"
    ...
    defaultConfig {
        applicationId = "com.custom.srt_stream"
    ...
    signingConfigs {
        create("release") {
            val keystorePath = System.getenv("KEYSTORE_PATH") ?: keyProperties.getProperty("storeFile") ?: "upload-keystore.jks"
